import { BASEMENT_TYPES, GROUNDWATER_CONDITIONS, getBasementRockyAdjustment } from "../../constants/construction";
export function calculateBasementCosts(input) {
    var _a, _b, _c, _d, _e;
    ...
    if (input.siteConditionIsRocky) {
        const rockyAdjustment = getBasementRockyAdjustment(totalBasementArea);
        basementStructureCost =
